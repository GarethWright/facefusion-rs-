...
{
	/// <summary>
	/// Localization strings for the FaceFusion application.
	/// Ported from facefusion/locales.py.
	/// Each string may contain named placeholders like {version}, {job_id}, etc.
	/// </summary>
	public static class Locales
	{
		/// <summary>
		/// English locale strings. Top-level keys are either format strings or nested dictionaries.
		/// Access via Translator.Get() which handles nested keys (e.g., "help.run").
		/// </summary>
		public static readonly Dictionary<string, object> En = new Dictionary<string, object>()
		{
